...
.readonly-field .z-combobox-inp,
.readonly-field .z-datebox-inp,
.readonly-field .z-timebox-inp,
.readonly-field .z-textbox,
...
.mandatory-field .z-combobox-inp,
.mandatory-field .z-datebox-inp,
.mandatory-field .z-timebox-inp,
...
div.z-filetree-header tr.z-tree-cols,
div.z-tree-header tr.z-auxhead {
	background-image: url(../images/zul/grid/column-bg.png);
}
...
div.z-vfiletree-header tr.z-tree-cols,
div.z-tree-header tr.z-auxhead {
	background-image: url(../images/zul/grid/column-bg.png);
}
...
div.dp-doc-items td:hover, div.dp-fav-items td:hover, div.dp-rec-items .z-toolbarbutton:hover, div.dp-views-items .z-toolbarbutton:hover {
	background-image: url(../images/zul/common/focusd.png);
	background: #1F9BDE;
...
<%-- Smart Browser selection Button Style --%>

.sb-add-btn .z-button-tl,
.sb-add-btn .z-button-tr,
.sb-add-btn .z-button-bl,
.sb-add-btn .z-button-br {
	background-image: url();
	background-color: #137915;
}

.sb-add-btn .z-button-tm,
.sb-add-btn .z-button-bm {
	background-image: url();
	background-color: #137915;
}

.sb-add-btn .z-button-cl,
.sb-add-btn .z-button-cr {
	background-image: url();
	background-color: #137915;
}

.sb-add-btn .z-button-cm {
	background-image: url();
	background-color: #137915;
}


.sb-remove-btn .z-button-tl,
.sb-remove-btn .z-button-tr,
.sb-remove-btn .z-button-bl,
.sb-remove-btn .z-button-br {
	background-image: url();
	background-color: #ca5039;
}

.sb-remove-btn .z-button-tm,
.sb-remove-btn .z-button-bm {
	background-image: url();
	background-color: #ca5039;
}

.sb-remove-btn .z-button-cl,
.sb-remove-btn .z-button-cr {
	background-image: url();
	background-color: #ca5039;
}

.sb-remove-btn .z-button-cm {
	background-image: url();
	background-color: #ca5039;
}
