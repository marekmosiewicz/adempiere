...
<c:set var="ColorAzureBlue" value="#0093f9"/>
...
.z-textbox-focus,
.z-textbox-focus input,
.z-decimalbox-focus,
.z-decimalbox-focus input,
.z-intbox-focus,
.z-intbox-focus input,
.z-longbox-focus,
.z-longbox-focus input,
.z-doublebox-focus,
.z-doublebox-focus input {}
...
tr.z-list-item-focus,
div.z-listcell-cnt-text {
	color: ${ColorWhite};
}
...
.z-datebox-calmon td,
.z-datebox-calday td,
.z-datebox-calday td a,
.z-datebox-calday td a:visited {
	color: ${Color01};
}
...
<%-- get consistency in typeface across the whole of the front screen --%>

div.recent-items td:hover {
...
<%-- An included tab image Background.  --%>

.adtab-grid-panel .z-row:nth-child(even) img {
	background-color: transparent !important;
}

.adtab-grid-panel .z-row:nth-child(odd) img {
	background-color: transparent !important;
}
...
.ssb-product-row.selected td {
	background: linear-gradient(to bottom, #65c9ff 0, #005ca7 100%) !important;
	border-bottom: 1px solid #003764 !important;
	border-top: 1px solid #015da8 !important;
}
...
.ssb-qty-tbl-row-total {
	background-color: #a4a4a4;
}

/**
 * ----------------------------------------
 * animation sb search-color-change
 * ----------------------------------------
 */

.sb-search-anim {
	-webkit-animation: search-color-change 2s cubic-bezier(0.680, -0.550, 0.265, 1.550) infinite alternate-reverse both;
	        animation: search-color-change 2s cubic-bezier(0.680, -0.550, 0.265, 1.550) infinite alternate-reverse both;
}

@-webkit-keyframes search-color-change {
  0%  {background: #00ff00;}
  50%  {background: #008c00;}
  100% {background: #003c00;}
}

@keyframes search-color-change {
  0%  {background: #00ff00;}
  50%  {background: #008c00;}
  100% {background: #003c00;}
}
